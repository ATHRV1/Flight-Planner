...
def main():
    ...
    test_cases = load_test_cases_from_file(r'C:\Users\HP\Flight Planner\Assignment 5\fli1000.txt')
...
if __name__ == "__main__":
    main()
    compare_outputs('output.txt', r'C:\Users\HP\Flight Planner\Assignment 5\model_output2.txt')